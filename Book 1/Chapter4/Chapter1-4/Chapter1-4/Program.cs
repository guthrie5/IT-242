...
namespace chapter1_4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //this is how you define or instantiate a variable(s)
            ...
            string studentLastName = "Guthrie";
            ...
            Console.WriteLine($"The student's name is {studentFirstName} {studentLastName}");

            //double is like int but you can have 2 decimal spots like below
            double GPA = 3.55;

            Console.WriteLine($"{studentFirstName} {studentLastName}'s GPA is {GPA}.");
            ...
            float[] allQuizGrades = new float[] { 99, 100, 84, 77, 7, 91, 13, 86 };

            //array of numbers that have 2 decimal places
